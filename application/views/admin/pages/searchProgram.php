        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">نتائج البحث عن <?php echo $Keyword ?>
                    </li>
                </ol>
            </div>
                        ...
                        <div class="card-deck-wrapper">
                            <div class="card-deck row dletter">
                                ...
                                if (count($Result)==0){
                                    ...
                                    echo "<div style=\"text-align: center\"><img style=\"margin: 60px auto 100px auto;\" class=\"img-responsive\" src=\"../assets/image/nofound1.png\" alt=\"لا تتوفر نتائج\"></div>";
