			...
			<div class="card">
				...
				<div class="card-body collapse in">
					<div class="card-block card-dashboard">
                      ...
                      <form class="form" novalidate="" action="<?php echo base_url().'admin/saveUpdateNews/'.$news->id?>" method="post" onsubmit="return validateForm()" enctype="multipart/form-data"/>
...
<!--                          <div class="controls">-->
<!--                            <div class="skin skin-square">-->
<!--                              <input type="checkbox" value="1" name="special" id="input-17"  --><?php // if( $news->special==1) echo 'checked';?><!-- />-->
<!--                              <label for="input-17">موضوع مميز</label>-->
<!--                            </div>-->
<!--                          </div></div>-->
                          </div>
                          ...
                          <div class="row" id="upload-img">
                              ...
                              <div class="col-md-3">
                                  <div class="form-group" style="margin-bottom: 10px">
                                      <div class="controls">
                                          <input type="file" onchange="openFile(event)" accept="image/x-png,image/gif,image/jpeg,image/jpg" name="imghome" id="filesToUpload"   class="img_found form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>
                                      </div></div>
                                  <div class="form-group">
...
<!--                                    <span class="plus input-group-btn"><button class="btn btn-primary bootstrap-touchspin-up" type="button"><i class="icon-plus4"></i></button></span>-->
                                ...
                                <div class="card-block  my-gallery" itemscope="" itemtype="http://schema.org/ImageGallery">
                                    <div class="row">
                                        <?php  foreach($Video as $post_video){?>
                                        <?php if ( $post_video->local_video!=null){
                                            ?>
                                            <div class="col-lg-3 col-md-6 col-xs-12" style="margin-bottom: 20px;" >
                                                    <video class="img-thumbnail img-fluid" style="height: 200px" width="300" height="200" controls>
                                                        <source src="<?php echo base_url()?><?php echo $post_video->local_video;?>" type="video/mp4">
                                                    </video>
                                                    <img class="videoRemove" src="<?php echo base_url();?>/admin-assets/images/icons/Delete.ico" id="<?php echo $post_video->id?>"/>
                                            </div>
                                        <?php } ?>
                                        <?php } ?>
...
<script>
    $('.videoRemove').on('click',function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('news/delVideoNews/');?>",
            data: {'id': vid.attr('id')},
            dataType: "text",
            cache:false,
            success:
