        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/course/<?php echo $Episode->program_id; ?>/episodes">حلقات البرنامج</a>
                    </li>
                    <li class="breadcrumb-item active">تعديل حلقة
                    </li>
                </ol>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="icon-tag"></i> تعديل حلقة </h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    ...
                                    <form class="form" novalidate="" action="<?php echo base_url().'admin/saveUpdateEpisode/'.$Episode->id?>" method="post" onsubmit="return validateForm()" enctype="multipart/form-data"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <input type="text" value="<?php  echo $Episode->name ?>" id="issueinput1" class="form-control" required="" data-validation-required-message=" عنوان الحلقة" placeholder="عنوان الحلقة" name="episode_name" data-toggle="tooltip" data-trigger="hover"  data-title="وصف الحلقة" />
                                                            </div></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <textarea id="issueinput4" rows="10" class="form-control" name="txt" placeholder="النص" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="النص" ><?php  echo $Episode->info ?></textarea>
                                                            </div></div></div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <select id="issueinput5" name="course" required="" class=" select2 select2-rtl form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="البرامج">
                                                                ...
                                                                {?>
                                                                    <option value="<?php  echo $course->id ?>" <?php if($Episode->program_id==$course->id) echo 'selected'?>><?php  echo $course->name ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
...
<!--                                                        <div class="form-group">-->
<!--                                                            <div class="controls">-->
<!--                                                                <input type="file" accept="image/x-png,image/gif,image/jpeg"  name="episode_img" id="filesToUpload"  class="form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>-->
<!--                                                            </div></div>-->
<!--                                                    </div>-->
<!---->
<!--                                                </div>-->
                                                ...
                                                <div class="row" id="upload-img">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group" style="margin-bottom: 10px">
                                                            <div class="controls">
                                                                <input type="file" onchange="openFile(event)" accept="image/x-png,image/gif,image/jpeg,image/jpg" name="episode_img" id="filesToUpload"   class="img_found form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>
                                                            </div></div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input type="text" id="im_ar" readonly="readonly" style="height: 37px" class="form-control" placeholder="إختيار من الأرشيف" value="<?php  echo $Episode->img ?>" name="img-archive" aria-describedby="button-addon6">
                                          ...
                                          <button onclick="openModal()" class="btn bg-blue-grey white "  style="height: 37px" type="button"><i class="icon-plus"></i></button>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div style=" height: 100px; width: 130px; overflow: hidden; left: 110px; ">
                                                            <img src="<?php echo base_url();?><?php  echo $Episode->img ?>" height="100px"  id="image-select" alt=" ">
                                                        </div>
                                                    </div></div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <input type="file" accept="audio/*"  name="episode_sound" id="filesToUpload"  class="form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>
                                                            </div></div>
                                                    </div>
                                                ...
                                                <div class="col-md-4 text-xs-right">
                                                    <div class="controls">
                                                        <div class="skin skin-square">
                                                            <input type="checkbox" name="show_home" value="1" id="input-15" <?php  if($Episode->show_home==1) echo 'checked';?>   />
                                        ...
                                        <div class="tab-pane fade " id="tabOnlyIcon13" aria-labelledby="baseOnlyIcon-tab13" aria-expanded="true">
                                            ...
                                            <div class="row form-body" id="link">
                                                ...
                                                <div class="card-block  my-gallery" itemscope="" itemtype="http://schema.org/ImageGallery">
                                                    <div class="row">
                                                        <?php  foreach($Video as $episode_video){?>
                                                            <?php if ( $episode_video->local_video!=null){
                                                                ...
                                                                <div class="col-lg-3 col-md-6 col-xs-12" style="margin-bottom: 20px;" >
                                                                    <video class="img-thumbnail img-fluid" style="height: 200px" width="300" height="200" controls>
                                                                        <source src="<?php echo base_url()?><?php echo $episode_video->local_video;?>" type="video/mp4">
                                                                    </video>
                                                                    <img class="videoRemove" src="<?php echo base_url();?>/admin-assets/images/icons/Delete.ico" id="<?php echo $episode_video->id?>"/>
                                                                </div>
                                                            <?php } ?>
                                                        <?php } ?>
...
<script>
    $('.videoRemove').on('click',function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('episode/delVideoEpisode/');?>",
            data: {'id': vid.attr('id')},
            dataType: "text",
            cache:false,
            success:
                function(data){
                    vid.parent().parent().remove();
