        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">حلقات برنامج <?php  echo $Course->name ?>
                    </li>
                </ol>
            </div>
                    ...
                    <div class="card-block">
                       <div class="card-deck-wrapper">
                            <div class="card-deck row dletter reorder-photos-list">
                                ...
                                {?>
                                    <div id="item_<?php echo $episode->id?>" class="col-md-3 ui-sortable-handle" oldValue="<?php echo $episode->id?>" newValue="<?php echo $episode->order_id?>">
...
<script>
    $(document).ready(function() {
        ...
        $( ".reorder-photos-list" ).sortable({
            opacity: 0.6,
            cursor: 'move',
//            connectWith: '.reorder-photos-list',
            update: function(event, ui){
//                var changedList = this.id;
                var order = $(this).sortable("toArray");
//                console.log(ui.item['context'].attributes.newValue.value);
//                console.log(ui.item.index());
                var current=ui.item['context'].attributes.newValue.value;
                var current2=ui.item['context'];
                //$( "div[newValue='"+current+"']" ).prev();
