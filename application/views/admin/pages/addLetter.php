        ...
        <div class="content-header row">
            <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">إضافة نشرة
                    </li>
                </ol>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><i class="icon-tag"></i> إضافة نشرة</h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    ...
                                    <form class="form" novalidate="" action="<?php echo base_url().'admin/saveLetter'?>" method="post" enctype="multipart/form-data" />
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <input type="text" id="issueinput2" name="letter_name" class="form-control" placeholder="عنوان النشرة" required="" data-validation-required-message="أدخـل عنوان النشرة"  data-toggle="tooltip" data-trigger="hover"  data-title="عنوان النشرة" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <input type="file"  accept="audio/*" name="letter_sound" id="filesToUpload" required class="form-control"  placeholder="" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title=""/>
                                                    </div></div>
                                            </div>
