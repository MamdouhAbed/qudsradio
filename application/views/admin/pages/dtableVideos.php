    ...
    <div class="content-body">
      ...
      <section id="image-grid" class="card">
        <div class="card-header">
          <h4 class="card-title"><i class="icon-tag"></i> إدارة الفيديو</h4>
          <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
          <div class="buttons-group btn-add-letter">
            <a href="<?php echo base_url();?>admin/addVideo" class="btn btn-info float-md-right"><i class="icon-plus4"></i> إضافة فيديو</a>
          </div>
                  ...
                  <div class="col-md-3 col-sm-6">
                    <div class="card border-grey border-lighten-2">
                      <div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
                        <div class="newsltr">
                          <img class="gallery-thumbnail" src="<?php echo base_url();?>thumb.php?src=<?php  echo $videos->imghome ?>&size=227x170" />
                        </div>
                      </div>
                      <div class="card-block text-xs-center">
                        <h4 class="card-title"><?php  echo $videos->title ?></h4>


                      </div>
                      <div class="text-xs-center btn_action">
                        <a href="<?php echo base_url().'admin/updateVideo/'.$videos->id?>" class="btn btn-social-icon mr-1 mb-1 btn-outline-info"><span class="icon-edit"></span></a>
                        <a id="<?php echo $videos->id?>" class=" btndelete btn btn-social-icon mr-1 mb-1 btn-outline-danger"><span class="icon-trash"></span></a>
                        <a target="_blank" href="<?php echo base_url();?>video/<?php  echo $videos->id ?>" class="btn btn-social-icon mr-1 mb-1 btn-outline-success"><span class="icon-video"></span></a>

                      </div>
                      <div class="insert_date text-xs-center">
                        <?php echo ArabicDate($videos->created_at); ?>
                      </div>
                    </div>
                  </div>
                  <?php
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel1"> حذف الفيديو </h4>
          </div>
          <form  id="form-delete" >
