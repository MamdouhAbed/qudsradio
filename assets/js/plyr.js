...
"object" == typeof navigator && function (e, t) {
    ...
    function g(e, t, n) {
        var i = this, a = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], s = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4], o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5];
    ...
    function M(e, t) {
        ...
        return e.split(",").forEach(function (e) {
            var t = e.trim(), a = t.replace(".", ""), s = t.replace(/[[\]]/g, "").split("="), o = s[0], r = s.length > 1 ? s[1].replace(/["']/g, "") : "";
            switch (t.charAt(0)) {
                case".":
    ...
    var V, F = {
        ...
        check: function (e, t, n) {
            var i = F.isIPhone && n && W.playsinline, a = W[e] || "html5" !== t;
    ...
    var ce = {
        getIconUrl: function () {
            ...
            var n = ce.getIconUrl.call(this), i = "".concat(n.cors ? "" : n.url, "#").concat(this.config.iconPrefix), a = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            ...
            var t = this, n = e.value, i = e.list, a = e.type, s = e.title, o = e.badge, r = void 0 === o ? null : o, l = e.checked, c = void 0 !== l && l, u = M(this.config.selectors.inputs[a]), d = A("button", J(u, {
                type: "button",
                role: "menuitemradio",
            ...
            if (m.element(t) && "range" === t.getAttribute("type")) {
                if (I(t, this.config.selectors.inputs.seek)) {
                    ...
                    var n = ce.formatTime(this.currentTime), i = ce.formatTime(this.duration), a = te("seekLabel", this.config);
            ...
            if (this.config.tooltips.seek && m.element(this.elements.inputs.seek) && m.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                var n = 0, i = this.elements.progress.getBoundingClientRect(), a = "".concat(this.config.classNames.tooltip, "--visible"), s = function (e) {
                    L(t.elements.display.seekTooltip, a, e)
                };
                if (this.touch)s(!1); else {
                    if (m.event(e))n = 100 / i.width * (i.right - e.pageX ); else {
                        if (!x(this.elements.display.seekTooltip, a))return;
                        n = parseFloat(this.elements.display.seekTooltip.style.right, 10)
                    }
                    n < 0 ? n = 0 : n > 100 && (n = 100), ce.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n), this.elements.display.seekTooltip.style.right = "".concat(n, "%"), m.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && s("mouseenter" === e.type)
                }
            }
            ...
            if (m.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]'), n = he.getTracks.call(this), i = Boolean(n.length);
            ...
            var e = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], i = document.getElementById("plyr-settings-".concat(this.id, "-").concat(t));
            if (m.element(i)) {
            ...
            if (this.config.controls.includes("captions") && n.appendChild(ce.createButton.call(this, "captions")), this.config.controls.includes("settings") && !m.empty(this.config.settings)) {
                ...
                var l = A("div", {
                    ...
                    hidden: ""
                }), c = A("div"), u = A("div", {id: "plyr-settings-".concat(e.id, "-home")}), d = A("div", {role: "menu"});
            ...
            if (window.navigator.userAgent.includes("Edge") && H(o), this.config.tooltips.controls) {
                var c = this.config, u = c.classNames, d = c.selectors, h = "".concat(d.controls.wrapper, " ").concat(d.labels, " .").concat(u.hidden), p = _.call(this, h);
    ...
    var he = {
        setup: function () {
            if (this.supported.ui)if (!this.isVideo || this.isYouTube || this.isHTML5 && !W.textTracks)m.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ce.setCaptionsMenu.call(this); else {
                var e, t;
            ...
            var e = this, t = he.getTracks.call(this, !0), n = this.captions, i = n.active, a = n.language, s = n.meta, o = n.currentTrackNode, r = Boolean(t.find(function (e) {
                return e.language === a
            }));
            ...
            if (this.supported.ui) {
                var n = this.captions.toggled, i = this.config.classNames.captions.active, a = m.nullOrUndefined(e) ? !n : e;
                if (a !== n) {
                    if (t || (this.captions.active = a, this.storage.set({captions: a})), !this.language && a && !t) {
                        var o = he.getTracks.call(this), r = he.findTrack.call(this, [this.captions.language].concat(s(this.captions.languages)), !0);
    ...
    }, me = "picture-in-picture", fe = "inline", ge = {
        html5: "html5",
        youtube: "youtube",
        vimeo: "vimeo"
    ...
    function ke() {
        if (this.enabled) {
            ...
            m.element(e) && (e.pressed = this.active), k.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0), F.isIos || function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (m.element(e)) {
                    var n = _.call(this, "button:not(:disabled), input:not(:disabled), [tabindex]"), i = n[0], a = n[n.length - 1];
    ...
    var Ee = {
        ...
        return n(t, [{
            ...
            key: "bind", value: function (e, t, n, i) {
                var a = this, s = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4], o = this.player, r = o.config.listeners[i], l = m.function(r);
            ...
            key: "controls", value: function () {
                ...
                if (n.buttons.play && Array.from(n.buttons.play).forEach(function (n) {
                        ...
                        var t = n.progress.getBoundingClientRect(), i = 100 / t.width * (t.right - e.pageX);
    ...
    var Le = {
        setup: function () {
            ...
            var t = a((m.string(e) ? e : this.config.ratio).split(":").map(Number), 2), n = 100 / t[0] * t[1];
            ...
            var s, o = (s = i, m.empty(s) ? null : m.number(Number(s)) ? s : s.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : s), r = A("iframe"), l = Q(t.config.urls.vimeo.iframe, o, n);
            ...
            Object.defineProperty(t.media, "loop", {
                ...
                if (n === t.elements.container) {
                    var i = "enterfullscreen" === e.type, s = a(Le.ratio.split(":").map(Number), 2), o = s[0] > s[1] ? "width" : "height";
    ...
    var Ie, _e = {
        setup: function () {
            ...
            if (m.empty(t) || !t.startsWith("youtube-")) {
                ...
                var i, a, s = (i = n, m.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i), o = (a = e.provider, "".concat(a, "-").concat(Math.floor(1e4 * Math.random()))), r = A("div", {
                    id: o,
                    poster: e.poster
                });
                e.media = S(r, e.media);
        ...
        setup: function () {
            this.media ? (L(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0), L(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0), this.isEmbed && L(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0), this.isVideo && (this.elements.wrapper = A("div", {class: this.config.classNames.video}), w(this.media, this.elements.wrapper), this.elements.poster = A("div", {class: this.config.classNames.poster}), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? z.extend.call(this) : this.isYouTube ? _e.setup.call(this) : this.isVimeo && Le.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Oe = function () {
        function t(n) {
            var i = this;
        ...
        return n(t, [{
            ...
            key: "pollCountdown", value: function () {
                ...
                this.countdownTimer = setInterval(function () {
                    var t = le(Math.max(e.manager.getRemainingTime(), 0)), n = "".concat(te("advertisement", e.player.config), " - ").concat(t);
                ...
                if (this.enabled) {
                    ...
                    n.restoreCustomPlaybackStateOnAdBreakComplete = !0, n.enablePreloading = !0, this.manager = e.getAdsManager(this.player, n), this.cuePoints = this.manager.getCuePoints(), m.empty(this.cuePoints) || this.cuePoints.forEach(function (e) {
                        if (0 !== e && -1 !== e && e < t.player.duration) {
                            ...
                            if (m.element(n)) {
                                var i = 100 / t.player.duration * e, a = A("span", {class: t.player.config.classNames.cues});
        ...
        insertElements: function (e, t) {
            ...
            Y(e, "sources.length") ? (z.cancelRequests.call(this), this.destroy.call(this, function () {
                ...
                var n = e.sources, i = e.type, s = a(n, 1)[0], o = s.provider, r = void 0 === o ? ge.html5 : o, l = s.src, c = "html5" === r ? i : "div", u = "html5" === r ? {} : {src: l};
                Object.assign(t, {
                    provider: r,
                    type: i,
        ...
        function t(n, i) {
            ...
            if (e(this, t), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = W.touch, this.media = n, m.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || m.nodeList(this.media) || m.array(this.media)) && (this.media = this.media[0]), this.config = J({}, pe, t.defaults, i || {}, function () {
                    ...
                    speed: [],
                    quality: []
                }, this.debug = new be(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", W), !m.nullOrUndefined(this.media) && m.element(this.media))if (this.media.plyr)this.debug.warn("Target already setup"); else if (this.config.enabled)if (W.check().api) {
        ...
        return n(t, [{
            ...
            key: "toggleControls", value: function (e) {
                if (this.supported.ui && !this.isAudio) {
                    var t = x(this.elements.container, this.config.classNames.hideControls), n = void 0 === e ? void 0 : !e, i = L(this.elements.container, this.config.classNames.hideControls, n);
            ...
            key: "duration", get: function () {
                var e = parseFloat(this.config.duration), t = (this.media || {}).duration, n = m.number(t) && t !== 1 / 0 ? t : 0;
                return e || n
            }
        }, {
            ...
            key: "quality", set: function (e) {
                ...
                if (n.length) {
                    var i = [!m.empty(e) && Number(e), this.storage.get("quality"), t.selected, t.default].find(m.number), a = !0;
                    if (!n.includes(i)) {
                        var s = function (e, t) {
